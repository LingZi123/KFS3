...
- (void)lew_presentPopupView:(UIView *)popupView position:(NSInteger)position animation:(id<LewPopupAnimation>)animation dismissed:(void (^)(void))dismissed{
    [self presentPopupView:popupView position:position  animation:animation dismissed:dismissed];
}

- (void)lew_presentPopupView:(UIView *)popupView position:(NSInteger)position animation:(id<LewPopupAnimation>)animation{
    [self presentPopupView:popupView position:position  animation:animation dismissed:nil];
}
...
- (void)presentPopupView:(UIView*)popupView position:(NSInteger)position animation:(id<LewPopupAnimation>)animation dismissed:(void(^)(void))dismissed{
...
//        [overlayView addGestureRecognizer:tap];
    ...
    popupView.center = self.lewOverlayView.center;
     ...
     if (position==1){
        popupView.center=CGPointMake(self.lewOverlayView.center.x, self.lewOverlayView.frame.size.height-popupView.frame.size.height/2);
    }
    if (animation) {
