...
@implementation GFInputViewPluginVideo
...
- (void)pluginDidClicked
{
    ...
    GFVideoViewController  *vc=[[GFVideoViewController alloc]init];
    [conversationController presentViewController:vc animated:YES completion:nil];
    
    /// 构建一个自定义消息
//    NSDictionary *contentDictionary = @{
//                                        kSPCustomizeMessageType:@"GFVideo",
//                                        };
